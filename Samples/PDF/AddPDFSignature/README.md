# Add PDF Signature (AddPDFSignature)

When a PDF document needs a digital signature, ImageGear can provide a digital signature as an Interactive Form control

After a PDF document is set to contain forms using the CreateForm function, a signature field can be created that will provide a digital signature. The default appearance can be overridden. With only a call to CreateSignatureField and an ApprovalSignature object, a PDF can be signed and saved.
