# Add Text to a PDF page (PDFContentAddText)

When text needs to be added directly to a PDF page, ImageGear can insert text.
...
To build this sample under Linux, first install the Microsoft .NET SDK for your Linux distribution. After that, run `dotnet build PDFContentAddText.dotnet.sln`. By default this will build the Debug Solution Configuration.
...
To run this sample under Linux, run the sample from "bin/x64/Debug/net6.0/" using `./PDFContentAddText.dotnet`.
