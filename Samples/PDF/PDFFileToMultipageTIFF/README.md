...
- Build the sample using `dotnet build PDFFileToMultipageTIFF.dotnet.sln`. By default this will build the Debug Solution Configuration.
...
To run this sample under Linux, run the sample from "bin/x64/Debug/net6.0/" using `./PDFFileToMultipageTIFF.dotnet`.
