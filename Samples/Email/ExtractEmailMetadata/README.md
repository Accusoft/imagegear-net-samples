# Extract Email Metadata (ExtractEmailMetadata)

When the metadata from an Email document is needed, ImageGear can access this information.
...
2. Run `dotnet build ExtractEmailMetadata.sln`. By default this will build the Debug Solution Configuration.
