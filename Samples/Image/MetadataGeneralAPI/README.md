...
- Build the sample using `dotnet build MetadataGeneralAPI.dotnet.sln`. By default this will build the Debug Solution Configuration.
...
To run this sample under Linux, run the sample from "bin/Debug/net5.0/" using `./MetadataGeneralAPI.dotnet`.
