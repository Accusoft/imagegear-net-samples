# Set and Save Form Field values into a PDF file (SetPDFFormFields)
...
2. Run `dotnet build SetPDFFormFields.sln`. By default this will build the Debug Solution Configuration.
