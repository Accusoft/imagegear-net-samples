# Convert Office File To Raster Format (OfficeFileToRasterFormat)
...
2. Run `dotnet build OfficeFileToRasterFormat.sln`. By default this will build the Debug Solution Configuration.
