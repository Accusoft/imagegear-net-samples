...
To build this sample under Linux, first install the Microsoft .NET SDK for your Linux distribution. After that, run `dotnet build OfficeFileToPDFFile.sln`. By default this will build the Debug Solution Configuration.
